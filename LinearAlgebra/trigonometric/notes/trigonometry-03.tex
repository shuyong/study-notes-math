...
\node[above] at (0.0,1.50) {Visualization of trigonometric functions : $\cos \theta$};
...
\draw [color=blue, dashed, ->,>=latex] ( {cos(\angle)}, {sin(\angle)} ) -- ( {2*cos(\angle)}, 0 ) ;
\draw [color=blue, dashed, ->,>=latex] ( {cos(\angle)},-{sin(\angle)} ) -- ( {2*cos(\angle)}, 0 ) ;
\draw [color=red, very thick, ->,>=latex] (0,0) -- ( {2*cos(\angle)}, 0 ) node[above right] {$2\cos\theta$} ;
