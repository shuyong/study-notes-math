...
\node[above] at (0.0,1.50) {Visualization of trigonometric functions : $\tan \theta$};
...
\draw [color=blue, very thick, ->,>=latex] (0,0) -- ( {cos(\angle)},-{sin(\angle)} ) ;
\draw [color=blue, very thick, ->,>=latex] (0,0) -- (-{cos(\angle)}, {sin(\angle)} ) ;
\draw [color=blue, dashed] ( {cos(\angle)}, {sin(\angle)} ) -- ( 1, {tan(\angle)} ) ;
\draw [color=blue, very thick, ->,>=latex] (1,0) --  ( 1, {tan(\angle)} ) ;
