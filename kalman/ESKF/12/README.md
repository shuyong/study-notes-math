# [Open Source for Drones - PX4 Open Source Autopilot](https://px4.io/)
...
2. [PX4 - EKF - documentation](https://github.com/PX4/ecl/tree/master/EKF/documentation)
...
6. [EKF2 Estimation System](https://ardupilot.org/dev/docs/ekf2-estimation-system.html)

7. [Extended Kalman Filter Navigation Overview and Tuning](https://ardupilot.org/dev/docs/extended-kalman-filter.html)

8. [Extended Kalman Filter (EKF)](https://ardupilot.org/copter/docs/common-apm-navigation-extended-kalman-filter-overview.html)
