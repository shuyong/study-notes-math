...
\node[above] at (0.0,1.9) {Reset the error covariance};
...
\node[below, rotate=-15] at (0.0,0.74) {\footnotesize$\boldsymbol{\Gamma}\left(\color{blue}\boldsymbol{\theta}\color{black}\right)\bar{\boldsymbol{P}}_{k}\boldsymbol{\Gamma}\left(\color{blue}\boldsymbol{\theta}\color{black}\right)^{\mathrm{T}}$};
