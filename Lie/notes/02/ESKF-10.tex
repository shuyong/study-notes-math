...
\draw [very thin, ->] (-0.03, 1.65) to [out=-15,in=100] node[above right] {Dynamic Matrix : $\mathbf{J}_{\delta\boldsymbol{\theta}}^{\mathsf{R}\oplus\delta\boldsymbol{\theta}}=\begin{cases}
\mathbf{J}_{r}\left(\delta\boldsymbol{\theta}\right) & \text{for }\boldsymbol{R}\\
\dfrac{1}{2}\boldsymbol{\Xi}\left(\delta\boldsymbol{\theta}\right) & \text{for }q
\end{cases}$} (1.14, 1.31) ;
