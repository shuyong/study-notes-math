...
\node[above] at (0.0,1.5) {Reset the error covariance};
...
\begin{scope} [shift={(0.0, 0.82)}, scale=0.08]
...
\node[below, rotate=-45] at (0.0,0.74) {\footnotesize$\boldsymbol{\Gamma}\left(\color{blue}\delta\boldsymbol{x}\color{black}\right)\hat{\boldsymbol{P}}_{k}\boldsymbol{\Gamma}\left(\color{blue}\delta\boldsymbol{x}\color{black}\right)^{\mathrm{T}}$};
